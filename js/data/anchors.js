...
(function (G) {
  ...
  // ---------- 小升初（本章终章） ----------
  {
          ...
          choices: [
            {
              ...
              cost: { energy: 1 },
              effects: { energy: -1, security: 3, marriage: 2, log: { text: '初潮那晚的长谈。她说"妈/爸，其实我早就知道了，同学都讲过"——但你的那部分，她记了很多年。', hl: true } },
              result: isMama
    ...
    // ---------- 变声与喉结（男孩） ----------
    {
      ...
      text: '饭桌上他喊了声"妈"，那声音像一根被踩了尾巴的二胡——前半句童声，后半句突然降了八度。\n他自己愣了一下，全家愣了三秒，然后弟弟/妹妹/你憋笑憋出了内伤。他放下碗就回了房间。\n那周之后，他说话越来越少——不是不想说，是每次开口都在赌嗓子的走向。',
      choices: [
        {
        ...
        return {
          ...
          choices: [
            ...
            },
            {
              ...
              result: '卷起的裤脚在校门口格外显眼。同学问"你裤子怎么这么长"，他说"我妈/爸说能穿两年"。\n那天的晚饭他吃得很快。',
            },
          ],
        };
      },
      ...
      choices: [
        {
          ...
          result: '理发店里他挑染了一撮很低调的深棕。走出店门的时候，他看了一眼镜子，笑了。\n周一到校，班主任让他戴了一周帽子——但那撮头发过两周就褪没了，而他记住了"我妈/爸带我去染的"。',
        },
        {
          text: '"校规就是校规。不行。"',
          effects: { security: -2 },
    ...
    // ---------- 中考与分流（本章终章） ----------
    {
      ...
      make(state) {
        ...
        const lieEcho = state.flags['谎言升级']
          ...
          : state.flags['诚实被温柔对待']
            ? '（出考场他就给你发了消息："妈/爸，物理最后一道大题我蒙的。"连蒙的都汇报——这条线，你们走了十二年。）'
            : '';
        ...
        return {
          ...
          choices: [
            {
              text: '尘埃落定，全家吃顿好的',
              effects: { marriage: 3, security: 2, setFlags: { [trackFlag]: '中考的答案，十五年养育的总分' }, log: { text: `中考出分：${score}。饭桌上他把杯子举向你："谢谢妈/爸。"——初中三年，就这一句，够了。`, hl: true } },
        ...
        return {
          ...
          choices: [
            ...
            },
            {
              ...
              result: '职业测评报告八页纸，结论和他的直觉一致。他把报告折好放进书包："妈/爸，这下你信了吧。"\n你信了——不是信报告，是信他终于学会了用证据说话。',
            },
          ],
        };
      },
        ...
        return {
          ...
          choices: [
            ...
            },
            {
              ...
              result: '"妈/爸的钱不够，但你的路不能堵。"——你们找到了折中方案：周末班+网课，费用两万八。\n他比谁都珍惜那两万八——因为知道那是怎么省出来的。',
            },
          ],
        };
      },
          ...
          choices: [
            {
              ...
              cost: { energy: 2 },
              effects: { energy: -2, security: 6, mama: 5, setFlags: { '被接住': '那句"活着好累"落进了稳稳的手里' }, log: { text: '那个深夜的长谈。天亮的时候他说："妈/爸，我想请两天假。"——你批了，像批一份病假条，因为确实是。', hl: true } },
